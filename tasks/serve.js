			...
			try{
				...
				jwt.verify(token,cert,{algorithms: ['RS256']}, function(err, payload){
					if(err){
						...
						render(res, 401, unauthTmpl, null, {info: 'unauthorized'}, options.port);
					} else{
						// forward request
 ...
 */
function render(response, code, template, data, info, port) {
